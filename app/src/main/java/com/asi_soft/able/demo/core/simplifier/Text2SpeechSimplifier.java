 ...
 */
public class Text2SpeechSimplifier extends Simplifier {
    /**
     * Method to process selected parameters and open the <code>DisplaySpeechActivity</code>.
     *
     * @param inputText
     * @param context
     * @param language
                ...
                if (result.length() == 0) {
                    ...
                    try {
                        ...
                        if (status.compareTo("200") == 0) {
                            Intent intent = new Intent(context, DisplaySpeechActivity.class);
