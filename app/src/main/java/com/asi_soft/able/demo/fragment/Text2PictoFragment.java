...
import com.asi_soft.able.demo.core.simplifier.Text2PictoSimplifier;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        buttonText2Picto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Simplifier simplifier = new Text2PictoSimplifier();
                simplifier.simplifyText(inputText, getActivity(),
